...
frase='Curso em Video Python'
# Aqui tempos uma ferramenta muito importante para analizar strting "len":
# len - significa comprimento da string.
# Ex.:
len(frase)
# irá moistra 21 caracteres.

frase='Curso em Video Python'
# Algumas formas utilizando "count":
# count -  signfica que irá contar quantas vezes aparece a letras na frase.
# Ex.: 'o' - 3
# Outro exemplo:
frase.count('o', 0 , 13)
...
# Exemplo:
'curso' in frase
# Essa não é uma funcionalidade, é um operador.
...
# Esse tipo de funcionalidade utiliza "()" (parenteses) no final, significa que ela é um método.
...
# o programa irá númerar as palavras da frase, começando do 0.
